...
public enum IItem {
    ...
    NECROMANCER_SHOVEL(Type.WEAPON, new ItemBuilder(Material.DIAMOND_SPADE).name("&rNecromancer's Diamond Spade &7(X)").enchantment(Enchantment.DAMAGE_ALL, 1).make(), 12),
    ...
    PIGMAN_SWORD(Type.WEAPON, new ItemBuilder(Material.GOLD_SWORD).name("&rPigman's Gold Sword &7(X)").enchantment(Enchantment.DAMAGE_ALL, 2).enchantment(Enchantment.DURABILITY, 10).make(), 17),
    ...
    FISHERMAN_ROD(Type.PROJECTILE, new ItemBuilder(Material.FISHING_ROD).name("&rFisherman's Fishing Rod &7(X)").enchantment(Enchantment.DAMAGE_ALL, 5).enchantment(Enchantment.LUCK, 3).enchantment(Enchantment.DURABILITY, 1).make(), 20),
    ...
    RANGER_BOW(Type.BOW, new ItemBuilder(Material.BOW).name("&rRanger's Bow &7(X)").enchantment(Enchantment.ARROW_DAMAGE, 1).enchantment(Enchantment.ARROW_KNOCKBACK, 2).make(), 20),
    ...
    REAPER_POT(Type.CONSUMABLE, new ItemBuilder(Material.POTION).name("&fReaper Potion").addPotionEffect(new PotionEffect(PotionEffectType.WITHER, 20 * 6, 2)).addPotionEffect(new PotionEffect(PotionEffectType.SLOW, 20 * 6, 0)).durability(16392).amount(3).make(), 15),
