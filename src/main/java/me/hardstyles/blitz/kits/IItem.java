...
public enum IItem {
    ...
    WARRIOR_POT(new ItemBuilder(Material.POTION).name("&fWarrior Potion").addPotionEffect(new PotionEffect(PotionEffectType.REGENERATION, 20 * 8, 0)).addPotionEffect(new PotionEffect(PotionEffectType.SPEED, 20 * 8, 0)).amount(3).make(), 15),
    REAPER_POT(new ItemBuilder(Material.POTION).name("&fReaper Potion").addPotionEffect(new PotionEffect(PotionEffectType.WITHER, 20 * 6, 2)).addPotionEffect(new PotionEffect(PotionEffectType.SLOW, 20 * 6, 0)).amount(3).make(), 15),
    BAKER_POT(new ItemBuilder(Material.POTION).name("&fBaker Potion").addPotionEffect(new PotionEffect(PotionEffectType.REGENERATION, 20 * 8, 0)).addPotionEffect(new PotionEffect(PotionEffectType.DAMAGE_RESISTANCE, 20 * 8, 0)).amount(3).make(), 15),
